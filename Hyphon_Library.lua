...
do
    ...
    do
        ...
        function library.meta.options.textbox:handle_keypress(input)
            ...
            elseif input.KeyCode == Enum.KeyCode.Return or input.KeyCode == Enum.KeyCode.Escape or input.UserInputType == Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch or input.UserInputType == Enum.UserInputType.MouseButton2 then
                self:release()
                if self.numeric then
                ...
                if library.dropdown.selected == dropdown then
                    ...
                    if inputservice:IsKeyDown(Enum.KeyCode.LeftControl) then
                        ...
                        local c; c = library:connection(inputservice.InputBegan, function(input)
                            ...
                            elseif input.KeyCode == Enum.KeyCode.Return or input.KeyCode == Enum.KeyCode.Escape or input.UserInputType == Enum.UserInputType.MouseButton1 or Enum.UserInputType.Touch then
                                c:Disconnect()
                                dropdown.searching = false
